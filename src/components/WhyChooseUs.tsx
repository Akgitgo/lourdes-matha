...
import { X, Maximize2, XCircle } from 'lucide-react';
            ...
            <AnimatePresence>
              {isModalOpen && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  exit={{ opacity: 0 }}
                  className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 md:p-10 bg-black/90 backdrop-blur-sm"
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100 flex-shrink-0">
                      <div className="flex items-center gap-3">
                        <div className="bg-[#B8860B]/10 p-2 rounded-lg">
                          <Maximize2 className="w-5 h-5 text-[#B8860B]" />
                        </div>
                        <h3 className="text-lg font-bold font-['Playfair_Display'] text-[#1a1a1a]">
                          Our Brochure <span className="text-[#B8860B]">Preview</span>
                        </h3>
                      </div>
                      <button
                        onClick={() => setIsModalOpen(false)}
                    ...
                    <div className="flex-1 overflow-auto p-4 sm:p-6 bg-gray-50 flex items-center justify-center">
                      <div className="relative w-full h-full min-h-[400px]">
                        <Image
                          src="/images/hospital_inner.jpg"
                          alt="Lourdes Matha Hospital Brochure"
                          fill
                    ...
                    {/* Modal Footer */}
                    <div className="px-6 py-4 bg-[#2d5a4f] text-white flex items-center justify-between text-xs sm:text-sm font-['Inter'] flex-shrink-0">
                      <span className="opacity-80">© Lourdes Matha Ayurvedic Hospital</span>
                      <button
                        onClick={() => setIsModalOpen(false)}
                        className="bg-white/10 hover:bg-white/20 px-4 py-1.5 rounded-full transition-colors font-medium border border-white/20"
                      >
                        Close View
                      </button>
                    </div>
